...
gcloud dataproc clusters create my-cluster --region=$REGION --zone ${REGION}-a --initialization-actions="gs://${PROJECT_ID}/cluster_initialize.sh" --num-workers=2 --max-age="2h" --driver-log-levels root=FATAL
